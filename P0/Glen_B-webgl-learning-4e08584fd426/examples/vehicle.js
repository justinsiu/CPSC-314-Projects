	...
	initScene = function() {
		...
		scene.addEventListener(
			...
			function() {
				...
				if ( input && vehicle ) {
					...
					if ( input.power === true ) {
						vehicle.applyEngineForce( 30 ); // CHANGE: the force applied from the engine.
		...
		var number_of_items = 50; // CHANGE: the number of boxes in the simulation
		for ( i = 0; i < number_of_items; i++ ) { 
			...
			// CHANGE: Try some new geometry in the scene
			/*
